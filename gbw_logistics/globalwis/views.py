...
class ContactCreateUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        if uploaded_image:
            ...
            with open(os.path.join(settings.BASE_DIR, 'static', 'assets', 'profileimg', uploaded_image.name), 'wb+') as destination:
...
class ImageUploadView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            with open(os.path.join(settings.BASE_DIR, 'static', 'assets', 'images', 'packages', image.name), 'wb+') as destination:
